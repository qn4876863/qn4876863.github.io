...
function SnowStorm() {
  ...
  this.resizeHandlerAlt = function () {
    screenX =
      targetElement.offsetLeft + targetElement.offsetWidth - flakeRightOffset
    screenY = flakeBottom
      ? flakeBottom
  ...
  this.SnowFlake = function (parent, type, x, y) {
    ...
    this.o.src =
      imagePath + this.type + (pngSupported && usePNG ? '.png' : '.gif')
    ...
    this.move = function () {
      ...
      if (s.vX && screenX - s.x < flakeWidth + s.vX * windOffset) {
        ...
        (s.vX < 0 || windOffset < 0) &&
        s.x - flakeLeftOffset < 0 - flakeWidth
      ) {
